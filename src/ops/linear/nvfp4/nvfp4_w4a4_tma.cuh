...
// rejects over-aligned by-value parameters when it compiles the CUDA host stub. The encoded bytes
// travel in natural alignment and are reinterpreted where the tensormap is consumed.
