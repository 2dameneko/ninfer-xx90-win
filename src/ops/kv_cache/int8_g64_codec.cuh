...
// ---------------------------------------------------------------------------
// Rotated/packed KV modes (rk8v4, rk4v4, rk4v4-e8, rk2v4-e8). K and V are
// optionally rotated per 64-group by an H64 transform before encoding; packed
// modes store two signed 4-bit codes per byte. The E8 lattice codecs themselves
// live in ops/kernel/e8_lattice.cuh and ops/kernel/e8_root_codec.cuh; this
// header only owns the shared index math and scalar helpers.
// ---------------------------------------------------------------------------
