...
// translation unit uses it, so those move specializations are written out by hand. The destructors
// stay `= default` (which MSVC emits reliably) and simply clear the owned implementation.
